...
class StartsWithOperator extends DefaultFindOperator<string> implements FindOperator<string> {
...
export const StartsWith = createFindOperator(StartsWithOperator);
